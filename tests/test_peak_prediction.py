...
def run(playwright: Playwright) -> None:
    ...
    page.locator("span").filter(has_text="Dashboard").click()
    page.get_by_role("button", name="Sherpa").click()
    page.get_by_role("button", name="Go to App").nth(2).click()
    ...
    page.locator(".highcharts-point.highcharts-point-hover").click()
    page.locator(".w-\\[2\\.4vw\\].h-\\[1\\.2vw\\]").click()
    page.locator(".w-\\[2\\.4vw\\].h-\\[1\\.2vw\\]").click()
    page.locator(".highcharts-series.highcharts-series-3 > .highcharts-point.highcharts-point-hover").click()
    page.locator(".highcharts-series.highcharts-series-3 > .highcharts-point.highcharts-point-hover").click()
